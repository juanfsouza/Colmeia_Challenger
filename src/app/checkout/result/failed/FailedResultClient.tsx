...
export function FailedResultClient() {
  const searchParams = useSearchParams()
  const router = useRouter()
  const orderId = searchParams.get('orderId')
  const paymentMethod = searchParams.get('paymentMethod') || 'pix'

  console.log('FAILED PAGE - orderId:', orderId, 'paymentMethod:', paymentMethod)
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      >
        ...
        <p className="text-md text-gray-600 dark:text-gray-400 mb-8 max-w-prose mx-auto">
          Ocorreu um problema durante o processamento. Verifique os dados informados e tente novamente.
        </p>
